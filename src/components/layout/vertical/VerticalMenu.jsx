      ...
      <Menu menuItemStyles={menuItemStyles(theme)}>
        ...
        <MenuItem href='/dispute'
         ...
         icon={<i className='ri-file-warning-line' />}
          ...
          >
            <MenuItem href='/en/terms-conditions' active={isSelected('/terms-conditions')}>Terms & Conditions</MenuItem>
            <MenuItem href='/en/privacy-policy' active={isSelected('/privacy-policy')}>Privacy Policy</MenuItem>
            <MenuItem href='/en/faqs' active={isSelected('/faqs')}>FAQ's</MenuItem>
          </SubMenu>
